...
test("/composites/toasts.demo - interaction", async ({ page }) => {
  ...
  const buttonTopStart = page.locator(
    '[popovertarget="top-start-toast"].contrast',
  );
  const buttonTopCenter = page.locator(
    '[popovertarget="top-center-toast"].contrast',
  );
  const buttonTopEnd = page.locator('[popovertarget="top-end-toast"].contrast');
  const buttonMiddleStart = page.locator(
    '[popovertarget="middle-start-toast"].contrast',
  );
  const buttonMiddleCenter = page.locator(
    '[popovertarget="middle-center-toast"].contrast',
  );
  const buttonMiddleEnd = page.locator(
    '[popovertarget="middle-end-toast"].contrast',
  );
  const buttonBottomStart = page.locator(
    '[popovertarget="bottom-start-toast"].contrast',
  );
  const buttonBottomCenter = page.locator(
    '[popovertarget="bottom-center-toast"].contrast',
  );
  const buttonBottomEnd = page.locator(
    '[popovertarget="bottom-end-toast"].contrast',
  );
