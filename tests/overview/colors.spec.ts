...
themes.forEach((theme) => {
  test(`/overview/colors.demo/main?theme=${theme} - visual snapshot`, async ({
    page,
  }) => {
    await page.goto(`/overview/colors.demo/main?theme=${theme}`);
  ...
  palettes.forEach((palette) => {
    test(`/overview/colors.demo/main?theme=${theme}&palette=${palette} - visual snapshot`, async ({
      page,
    }) => {
      await page.goto(
        `/overview/colors.demo/main?theme=${theme}&palette=${palette}`,
      );
      const main = page.locator("body > main");
