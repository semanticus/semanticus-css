...
<HtmlPreviewer :code="GhostDemo.overview({ class: 'danger' })" :codeCollapsed="true" />

<script setup>
import { GhostDemo, SubtleDemo, DangerDemo } from '@demos/variants';
</script>
