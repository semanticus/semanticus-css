...
const variableGroups = [
  ...
  },
  {
    ...
    vars: [
      ...
      { name: '--color-primary-underline', label: 'Primary Underline', desc: 'Underline color for primary links.', type: 'text', lightDefault: 'oklch(from #0172ad l c h / 0.5)', darkDefault: 'oklch(from #01aaff l c h / 0.5)', scope: 'theme', selectors: 'a:not([role=button]):not(.secondary):not(.contrast)' },
      ...
      { name: '--color-primary-underline-hover', label: 'Primary Hover Underline', desc: 'Underline color on hover for primary links.', type: 'text', lightDefault: '#015887', darkDefault: '#79c0ff', scope: 'theme', selectors: 'a:not([role=button]):not(.secondary):not(.contrast)' },
  ...
  },
  {
    ...
    vars: [
      ...
      { name: '--color-secondary-underline', label: 'Secondary Underline', desc: 'Underline color for secondary links.', type: 'text', lightDefault: 'oklch(from #5d6b89 l c h / 0.5)', darkDefault: 'oklch(from #969eaf l c h / 0.5)', scope: 'theme', selectors: 'a.secondary' },
      ...
      { name: '--color-secondary-underline-hover', label: 'Secondary Hover Underline', desc: 'Underline color on hover for secondary links.', type: 'text', lightDefault: '#48536b', darkDefault: '#b3b9c5', scope: 'theme', selectors: 'a.secondary' },
  ...
  },
  {
    ...
    vars: [
      ...
      { name: '--color-contrast-underline', label: 'Contrast Underline', desc: 'Underline color for contrast links.', type: 'text', lightDefault: 'oklch(from #181c25 l c h / 0.5)', darkDefault: 'oklch(from #f8f9fa l c h / 0.5)', scope: 'theme', selectors: 'a.contrast' },
      ...
      { name: '--color-contrast-underline-hover', label: 'Contrast Hover Underline', desc: 'Underline color on hover for contrast links.', type: 'text', lightDefault: '#000000', darkDefault: '#ffffff', scope: 'theme', selectors: 'a.contrast' },
