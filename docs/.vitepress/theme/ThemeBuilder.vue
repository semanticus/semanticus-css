...
const exportSnippet = computed(() => {
  let result = `<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@semanticus/semanticus-css@0.4.0/dist/semanticus.css">\n`;
  if (currentPalette.value !== 'azure') {
    result += `<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@semanticus/semanticus-css@0.4.0/dist/semanticus.palette.${currentPalette.value}.css">\n`
  }
  if (currentSize.value !== 'default') {
    result += `<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@semanticus/semanticus-css@0.4.0/dist/semanticus.size.${currentSize.value}.css">\n`
  }
