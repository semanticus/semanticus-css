...
const exportSnippet = computed(() => {
  let result = `<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@goncalvesjoao/semanticus-css@0.2.1/dist/semanticus.css">\n`;
  if (currentPalette.value !== 'azure') {
    result += `<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@goncalvesjoao/semanticus-css@0.2.1/dist/semanticus.palette.${currentPalette.value}.css">\n`
  }
  if (currentSize.value !== 'default') {
    result += `<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@goncalvesjoao/semanticus-css@0.2.1/dist/semanticus.size.${currentSize.value}.css">\n`
  }
