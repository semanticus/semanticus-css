...
const cdnSnippet = computed(() => {
  const paletteName = currentPalette.value
  const sizeName = currentSize.value
  let snippet = '<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@semanticus/semanticus-css@0.4.0/dist/semanticus.css">'
  if (paletteName !== 'azure') {
    snippet += `\n<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@semanticus/semanticus-css@0.4.0/dist/semanticus.palette.${paletteName}.css">`
  }
  if (sizeName !== 'default') {
    snippet += `\n<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@semanticus/semanticus-css@0.4.0/dist/semanticus.size.${sizeName}.css">`
  }
  return snippet
})
      ...
      <div class="install-modal" @click.stop>
        ...
        <div class="install-content">
          ...
          <div v-if="installMode === 'manual'">
            <p class="install-description">Download the <a href="https://registry.npmjs.org/@semanticus%2Fsemanticus-css/-/semanticus-css-0.4.0.tgz" target="_blank">distribution files</a>, move the ones you need to your <strong>stylesheets</strong> folder and include them in your HTML <code>&lt;head&gt;</code>:</p>
