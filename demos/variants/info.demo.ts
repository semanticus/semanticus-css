...
export function basicRoleLink(attrs: Record<string, string> = {}) {
  return RoleLinkDemo.main("button", { ...attrs, class: ["info", attrs.class || ""].join(' ') });
}
...
export function basicRoleButton(attrs: Record<string, string> = {}) {
  return RoleButtonDemo.main("div", { ...attrs, class: ["info", attrs.class || ""].join(' ') });
}

export function basicDetails() {
  return renderElement("details", {}, `${renderElement("summary", { role: 'button', class: 'info' }, 'Accordion')}
<p>
...
export function basicPane(attrs: Record<string, string> = {}) {
  return PaneDemo.main("div", { ...attrs, class: ["info", attrs.class || ""].join(' ') });
}

export function paneWithHeaderAndFooter(attrs: Record<string, string> = {}) {
  return PaneDemo.withHeaderAndFooter("div", { ...attrs, class: ["info", attrs.class || ""].join(' ') });
}
...
export function basicPanel(attrs: Record<string, string> = {}) {
  return PanelDemo.main("div", { ...attrs, class: ["info", attrs.class || ""].join(' ') });
}

export function panelWithHeaderAndFooter(attrs: Record<string, string> = {}) {
  return PanelDemo.withHeaderAndFooter("div", { ...attrs, class: ["info", attrs.class || ""].join(' ') });
}
