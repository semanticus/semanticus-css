...
${InputDemo.submit({ ...attrs, class: `ghost ${_class || ''}` })}`)}

${renderElement('section', { role: 'toolbar' }, `${InputDemo.reset(attrs)}
${InputDemo.reset({ ...attrs, class: `ghost ${_class || ''}` })}`)}

${renderElement('section', { role: 'toolbar' }, `${RoleButtonDemo.main('div', attrs, 'DIV as Button')}
${RoleButtonDemo.main('div', { ...attrs, class: `ghost ${_class || ''}` }, 'DIV as Button')}`)}
...
${renderElement('section', { role: 'toolbar' }, `${ButtonDemo.main({ ...attrs, class: `ghost ${_class || ''}` })}
...
${CardDemo.main('div', { ...attrs, class: `ghost ${_class || ''}` })}`)}
