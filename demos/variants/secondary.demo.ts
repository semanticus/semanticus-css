...
export function basicA(attrs: Record<string, string> = {}) {
  return ADemo.main({ ...attrs, class: ["secondary", attrs.class || ""].join(' ') });
}

export function basicRoleLink(attrs: Record<string, string> = {}) {
  return RoleLinkDemo.main("button", { ...attrs, class: ["secondary", attrs.class || ""].join(' ') });
}
...
export function basicButton(attrs: Record<string, string> = {}) {
  return ButtonDemo.main({ ...attrs, class: ["secondary", attrs.class || ""].join(' ') });
}

export function basicRoleButton(attrs: Record<string, string> = {}) {
  return RoleButtonDemo.main("div", { ...attrs, class: ["secondary", attrs.class || ""].join(' ') });
}

export function basicDetails() {
  return renderElement("details", {}, `${renderElement("summary", { role: 'button', class: 'secondary' }, 'Accordion')}
<p>
...
export function basicPane(attrs: Record<string, string> = {}) {
  return PaneDemo.main("div", { ...attrs, class: ["secondary", attrs.class || ""].join(' ') });
}

export function paneWithHeaderAndFooter(attrs: Record<string, string> = {}) {
  return PaneDemo.withHeaderAndFooter("div", { ...attrs, class: ["secondary", attrs.class || ""].join(' ') });
}
...
export function basicPanel(attrs: Record<string, string> = {}) {
  return PanelDemo.main("div", { ...attrs, class: ["secondary", attrs.class || ""].join(' ') });
}

export function panelWithHeaderAndFooter(attrs: Record<string, string> = {}) {
  return PanelDemo.withHeaderAndFooter("div", { ...attrs, class: ["secondary", attrs.class || ""].join(' ') });
}
