...
export function withHeader(attrs: Record<string, string> = {}) {
  ...
  return renderElement("main", restArgs, `${HeaderDemo.main({ class: headerClass })}
${main()}`);
}
...
export function withFooter(attrs: Record<string, string> = {}) {
  ...
  return renderElement("main", restArgs, `${main()}
...
export function withArticle(attrs: Record<string, string> = {}) {
  ...
  return renderElement("main", restArgs, ArticleDemo.main({ class: articleClass }));
}
