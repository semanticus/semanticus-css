...
export function main(tagName: string = "div", attrs: Record<string, string> = {}) {
  return renderElement(tagName, { ...attrs, role: "search" }, `<input type="search" placeholder="Search...">
<button type="submit">Search</button>`);
}

export function withResetButton(tagName: string = "div", attrs: Record<string, string> = {}) {
  return renderElement(tagName, { ...attrs, role: "search" }, `<input type="search" placeholder="Search with reset...">
<input type="reset" value="Clear">
<button type="submit">Go</button>`);
}

export function withIconButton(tagName: string = "div", attrs: Record<string, string> = {}) {
  return renderElement(tagName, { ...attrs, role: "search" }, `<input type="search" placeholder="Search products...">
