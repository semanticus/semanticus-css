...
export function intentVariants(
  ...
  return `${main(tagName, classMergeAttributes(`primary ${modifier}`.trim(), attrs), `&lt;${tagName}&gt; as button`)}
  ${main(tagName, classMergeAttributes(`secondary ${modifier}`.trim(), attrs), `&lt;${tagName}&gt; as button`)}
  ${main(tagName, classMergeAttributes(`contrast ${modifier}`.trim(), attrs), `&lt;${tagName}&gt; as button`)}
  ${main(tagName, classMergeAttributes(`success ${modifier}`.trim(), attrs), `&lt;${tagName}&gt; as button`)}
${main(tagName, classMergeAttributes(`info ${modifier}`.trim(), attrs), `&lt;${tagName}&gt; as button`)}
${main(tagName, classMergeAttributes(`warning ${modifier}`.trim(), attrs), `&lt;${tagName}&gt; as button`)}
${main(tagName, classMergeAttributes(`danger ${modifier}`.trim(), attrs), `&lt;${tagName}&gt; as button`)}`;
}
