...
function base(attrs: Record<string, string>, slot: string) {
	return renderElement(
		"div",
		{ ...attrs, class: `flow-h ${attrs.class || ""}`.trim() },
		slot,
	);
}
...
export function withLeftSidebarAndHeader(attrs: Record<string, string> = {}) {
	...
	return base(
		restArgs,
		`${AsideDemo.leftSidebar({ class: leftSidebarClass })}
...
export function withLeftSidebarAndHeaderAndRightSidebar(
	attrs: Record<string, string> = {},
) {
	const { leftSidebarClass, headerClass, rightSidebarClass, ...restArgs } =
		attrs;
...
export function headerExample(attrs: Record<string, string> = {}) {
	return renderElement(
		"section",
		{ ...attrs, class: ["grid", attrs.class || ""].join(" ") },
		`<div>
    <h3>Header</h3>
    ${withHeader({
			class: "bg-danger",
...
export function withLeftSidebarAndFooterAndRightSidebar(
	attrs: Record<string, string> = {},
) {
	const { leftSidebarClass, footerClass, rightSidebarClass, ...restArgs } =
		attrs;
...
export function withLeftSidebarAndMainAndRightSidebar(
	attrs: Record<string, string> = {},
) {
...
export function withLeftSidebarAndMainWithHeader(
	attrs: Record<string, string> = {},
) {
...
export function withMainWithHeaderAndRightSidebar(
	attrs: Record<string, string> = {},
) {
...
export function withLeftSidebarAndMainWithHeaderAndRightSidebar(
	attrs: Record<string, string> = {},
) {
	const {
		leftSidebarClass,
...
export function withLeftSidebarAndMainWithFooter(
	attrs: Record<string, string> = {},
) {
...
export function withMainWithFooterAndRightSidebar(
	attrs: Record<string, string> = {},
) {
...
export function withLeftSidebarAndMainWithFooterAndRightSidebar(
	attrs: Record<string, string> = {},
) {
	const {
		leftSidebarClass,
...
export function withMainWithHeaderPlusFooter(
	attrs: Record<string, string> = {},
) {
	...
	return base(
		restArgs,
		MainDemo.withHeaderPlusFooter({
			class: `${mainClass} flow-v`.trim(),
			headerClass,
			footerClass,
		}),
	);
...
export function withLeftSidebarAndMainWithHeaderPlusFooter(
	attrs: Record<string, string> = {},
) {
	const { leftSidebarClass, mainClass, headerClass, footerClass, ...restArgs } =
		attrs;
...
export function withMainWithHeaderPlusFooterAndRightSidebar(
	attrs: Record<string, string> = {},
) {
	const {
		mainClass,
...
export function withLeftSidebarAndMainWithHeaderPlusFooterAndRightSidebar(
	attrs: Record<string, string> = {},
) {
	const {
		leftSidebarClass,
...
export function withLeftSidebarAndMainWithArticle(
	attrs: Record<string, string> = {},
) {
...
export function withMainWithArticleAndRightSidebar(
	attrs: Record<string, string> = {},
) {
...
export function withLeftSidebarAndMainWithArticleAndRightSidebar(
	attrs: Record<string, string> = {},
) {
	const {
		leftSidebarClass,
...
export function withMainWithHeaderPlusArticle(
	attrs: Record<string, string> = {},
) {
	...
	return base(
		restArgs,
		MainDemo.withHeaderPlusArticle({
			class: `${mainClass} flow-v`.trim(),
			headerClass,
			articleClass,
		}),
...
export function withLeftSidebarAndMainWithHeaderPlusArticle(
	attrs: Record<string, string> = {},
) {
	const {
		leftSidebarClass,
...
export function withMainWithHeaderPlusArticleAndRightSidebar(
	attrs: Record<string, string> = {},
) {
	const {
		mainClass,
...
export function withLeftSidebarAndMainWithHeaderPlusArticleAndRightSidebar(
	attrs: Record<string, string> = {},
) {
	const {
		leftSidebarClass,
...
export function withMainWithArticlePlusFooter(
	attrs: Record<string, string> = {},
) {
	...
	return base(
		restArgs,
		MainDemo.withArticlePlusFooter({
			class: `${mainClass} flow-v`.trim(),
			articleClass,
			footerClass,
		}),
...
export function withLeftSidebarAndMainWithArticlePlusFooter(
	attrs: Record<string, string> = {},
) {
	const {
		leftSidebarClass,
...
export function withMainWithArticlePlusFooterAndRightSidebar(
	attrs: Record<string, string> = {},
) {
	const {
		mainClass,
...
export function withLeftSidebarAndMainWithArticlePlusFooterAndRightSidebar(
	attrs: Record<string, string> = {},
) {
	const {
		leftSidebarClass,
...
export function withMainWithHeaderPlusArticlePlusFooter(
	attrs: Record<string, string> = {},
) {
	const { mainClass, headerClass, articleClass, footerClass, ...restArgs } =
		attrs;

	return base(
		restArgs,
		MainDemo.withHeaderPlusArticlePlusFooter({
			class: `${mainClass} flow-v`.trim(),
			headerClass,
			articleClass,
			footerClass,
...
export function withLeftSidebarAndMainWithHeaderPlusArticlePlusFooter(
	attrs: Record<string, string> = {},
) {
	const {
		leftSidebarClass,
...
export function withMainWithHeaderPlusArticlePlusFooterAndRightSidebar(
	attrs: Record<string, string> = {},
) {
	const {
		mainClass,
...
export function withLeftSidebarAndMainWithHeaderPlusArticlePlusFooterAndRightSidebar(
	attrs: Record<string, string> = {},
) {
	const {
		leftSidebarClass,
...
export function mainWithHeaderPlusFooterExample(
	attrs: Record<string, string> = {},
) {
	return renderElement(
		"section",
...
export function mainWithHeaderPlusArticleExample(
	attrs: Record<string, string> = {},
) {
	return renderElement(
		"section",
...
export function mainWithArticlePlusFooterExample(
	attrs: Record<string, string> = {},
) {
	return renderElement(
		"section",
...
export function mainWithHeaderPlusArticlePlusFooterExample(
	attrs: Record<string, string> = {},
) {
	return renderElement(
		"section",
