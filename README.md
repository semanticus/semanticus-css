...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@semanticus/semanticus-css@0.4.0/dist/semanticus.css">
...
Download the [distribution files](https://registry.npmjs.org/@semanticus%2Fsemanticus-css/-/semanticus-css-0.4.0.tgz), move the ones you need to your **stylesheets** folder and include them in your HTML `<head>`:
